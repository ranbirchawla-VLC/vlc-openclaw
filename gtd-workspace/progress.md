...
**O-1: Google People API** — GREEN 2026-05-10. Name resolution confirmed: "Heather VanHalen" → `heather@vanhalenevents.com`; event created with attendee invite. People API enabled on project 46609068030.
