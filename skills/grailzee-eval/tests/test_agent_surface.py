...
Validates the grailzee-eval entry in ~/.openclaw/openclaw.json after H:
- tools.allow: evaluate_deal, report_pipeline, ingest_sales, message
- no tools.deny block
"""
...
_1C_TOOLS_ALLOW = frozenset({"evaluate_deal", "report_pipeline", "ingest_sales", "message", "turn_state", "get_cycle_targets", "web_search"})
