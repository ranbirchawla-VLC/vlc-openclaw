...
help:
	...
	@echo "  make test-gtd-profile            - run profile module tests"
	@echo "  make test-gtd-update-profile     - run update_profile entry point tests"
...
test-gtd-calendar-write:
	$(PYTEST) gtd-workspace/scripts/calendar/test_create_event.py gtd-workspace/scripts/calendar/test_update_event.py gtd-workspace/scripts/calendar/test_cancel_event.py

test-gtd-contacts:
	$(PYTEST) gtd-workspace/scripts/contacts
...
test-gtd-profile:
	$(PYTEST) gtd-workspace/scripts/gtd/tests/test_profile.py

test-gtd-update-profile:
	$(PYTEST) gtd-workspace/scripts/gtd/tests/test_update_profile.py
...
test-gtd-llm-capability:
	$(PYTEST) gtd-workspace/scripts/tests/llm/test_capability_user_id.py -v -m llm
