...
export const TOOLS = [
  ...
  },
  {
    ...
    _spawn: "argv",
    name: "create_contact",
    description: "Create a new Google Contact. Returns {ok: true, data: {contact: {resource_name, name, email, phone, company, title}}}.",
    parameters: {
      type: "object",
      properties: {
        ...
        first_name: { type: "string", description: "Given name (used alongside last_name for structured name storage)." },
        ...
        phone_type: { type: "string", description: "Phone type: mobile (default), work, or home." },
        email_type: { type: "string", description: "Email type: work (default), home, or other." },
      },
      required: ["name", "email"],
    },
  },
